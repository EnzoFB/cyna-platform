...
@Tag(name = "Admin Products", description = "Manage the product catalog from the back office")
public class AdminProductController {
    ...
    @Operation(summary = "List products", description = "Returns a paginated list of products. Not cached.")
    @ApiResponses({
    ...
    public ResponseEntity<ApiResponse<PagedResponse<ProductResponse>>> listProducts(
        ...
        var query = new ListProductsQuery(
                ...
                available,
                categoryId,
                ProductQuerySupport.normalizeCategoryIds(categoryIds),
                search,
                monthlyPriceMin,
                monthlyPriceMax,
                annualPriceMin,
    ...
    @Operation(summary = "Get product by id", description = "Returns a product by UUID. Not cached.")
    @ApiResponses({
    ...
    public ResponseEntity<ApiResponse<ProductDetailResponse>> getProductById(@PathVariable UUID id) {
        ProductReadModel result = queryMediator.send(new GetProductByIdQuery(id));
        ...
        return ResponseEntity.ok()
                .cacheControl(ApiCachePolicies.NO_STORE)
                .body(ApiResponse.success(ProductDetailResponse.from(result)));
    }
    ...
    public ResponseEntity<Void> deleteProduct(@PathVariable UUID id) {
        Result<Void> result = mediator.send(new DeleteProductCommand(id));
